...
export default class component extends Component {
  ...
  handleChangeIn1(e) {
    e = e < 0 ? this.state.in1 : e
    this.setState({ in1: e }, () => this.updateResult())
  }
  handleChangeIn2(e) {
    e = e < 0 ? this.state.in2 : e
    this.setState({ in2: e }, () => this.updateResult())
  }
  handleChangeBottle(e) {
    e = e < 0 ? this.state.bottle : e
    this.setState({ bottle: e }, () => this.updateResult())
  }
  updateResult() {
    const { in1, in2, bottle } = this.state
    const part1 = parseInt(in1)
    const part2 = parseInt(in2)
    const bottle1 = parseInt(bottle)
    const calculated = dilution(part1, part2, bottle1)
    this.setState({
      result1: calculated.part1,
      result2: calculated.part2
    })
  }
  render() {
    const { in1, in2, bottle, result1, result2 } = this.state
    return (
      <MainLayout title="Mischungsrechner">
        <Result>
          <p>
            Mischungsverhältnis{' '}
            <span>
              {result1}ml:{result2}ml
            </span>
          </p>
        </Result>
        ...
        <PartInput
          ...
          min="1"
        />
        <p>Flaschengröße in ml:</p>
        <PartInput
          isBottle
          value={bottle}
          onChange={e => this.handleChangeBottle(e.target.value)}
          type="number"
          min="1"
        />
        <div>
          ...
          <PredefinedItem
            onClick={() => {
              this.handleChangeIn1(1), this.handleChangeIn2(2)
            }}
          >
            1:2
          </PredefinedItem>
          <PredefinedItem
            onClick={() => {
              this.handleChangeIn1(1), this.handleChangeIn2(4)
            }}
          >
            1:4
          </PredefinedItem>
          <PredefinedItem
            onClick={() => {
              this.handleChangeIn1(1), this.handleChangeIn2(10)
            }}
          >
            1:10
          </PredefinedItem>
          <PredefinedItem
            onClick={() => {
              this.handleChangeIn1(1), this.handleChangeIn2(15)
            }}
          >
            1:15
          </PredefinedItem>
          <p>Gängige Flaschen/Behälter</p>
          <PredefinedItem onClick={() => this.handleChangeBottle(100)}>
            100ml
          </PredefinedItem>
          <PredefinedItem onClick={() => this.handleChangeBottle(250)}>
            250ml
          </PredefinedItem>
          <PredefinedItem onClick={() => this.handleChangeBottle(473)}>
            473ml
          </PredefinedItem>
        ...
        <AppBanner>
          ...
          >
            <img
              ...
              src="https://glossbossimages.s3.eu-central-1.amazonaws.com/de-play-badge.png"
            />
          </a>
          <a
          ...
          c0-2.115,1.72-3.835,3.839-3.835h125.468c2.121,0,3.834,1.72,3.834,3.835L134.032,35.268L134.032,35.268z"
                ...
                <g>
                  <g>
                    <path
                      fill="#FFFFFF"
                      d="M30.129,19.783c-0.029-3.223,2.639-4.791,2.761-4.864c-1.511-2.203-3.853-2.504-4.676-2.528
              ...
              C33.508,24.923,30.162,23.647,30.129,19.783z"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M26.929,10.306c0.874-1.093,1.472-2.58,1.306-4.089c-1.265,0.056-2.847,0.875-3.758,1.944
              c-0.806,0.942-1.526,2.486-1.34,3.938C24.558,12.204,26.017,11.382,26.929,10.306z"
                ...
                <g>
                  <path
                    fill="#FFFFFF"
                    d="M53.681,31.502h-2.271l-1.244-3.908h-4.324l-1.185,3.908h-2.211l4.284-13.307h2.646L53.681,31.502z
             M49.792,25.954l-1.125-3.475c-0.119-0.355-0.342-1.191-0.671-2.508h-0.04c-0.131,0.566-0.342,1.401-0.632,2.508l-1.105,3.475
            H49.792z"
                  />
                  <path
                    fill="#FFFFFF"
                    d="M64.698,26.586c0,1.633-0.441,2.922-1.323,3.869c-0.79,0.844-1.771,1.264-2.942,1.264
            ...
            s0.984,0.721,1.668,0.721c0.803,0,1.428-0.309,1.875-0.928S62.526,27.679,62.526,26.665z"
                  ...
                  <path
                    fill="#FFFFFF"
                    d="M75.736,26.586c0,1.633-0.441,2.922-1.324,3.869c-0.789,0.844-1.77,1.264-2.941,1.264
            ...
            c0.428,0.48,0.984,0.721,1.67,0.721c0.803,0,1.428-0.309,1.875-0.928S73.564,27.679,73.564,26.665z"
                  ...
                  <path
                    fill="#FFFFFF"
                    d="M88.076,27.771c0,1.131-0.395,2.053-1.182,2.764c-0.867,0.777-2.076,1.164-3.625,1.164
            ...
            C87.807,26.08,88.076,26.85,88.076,27.771z"
                  ...
                  <path
                    fill="#FFFFFF"
                    d="M95.123,23.506h-2.35v4.66c0,1.184,0.416,1.777,1.244,1.777c0.383,0,0.697-0.033,0.949-0.1l0.059,1.619
            ...
            h1.402v-1.757l2.092-0.632v2.389h2.35V23.506z"
                  ...
                  <path
                    fill="#FFFFFF"
                    d="M105.727,26.625c0,1.475-0.422,2.686-1.264,3.633c-0.881,0.975-2.053,1.461-3.514,1.461
            ...
            c0.816,0,1.455-0.391,1.916-1.168C103.318,28.346,103.516,27.579,103.516,26.695z"
                  ...
                  <path
                    fill="#FFFFFF"
                    d="M112.656,23.782c-0.211-0.04-0.434-0.06-0.67-0.06c-0.752,0-1.33,0.283-1.738,0.85
            ...
            c0.223-0.631,0.578-1.138,1.066-1.52c0.473-0.342,0.986-0.514,1.539-0.514c0.197,0,0.375,0.014,0.533,0.039V23.782z"
                  ...
                  <path
                    fill="#FFFFFF"
                    d="M122.193,26.25c0,0.383-0.027,0.705-0.08,0.968h-6.396c0.025,0.948,0.336,1.673,0.928,2.173
            ...
            c-0.355,0.461-0.566,1.014-0.633,1.658H120.16z"
                ...
                <g>
                  <g>
                    <path
                      fill="#FFFFFF"
                      d="M47.427,13.432h-3.715V6.894h1.048v5.655h2.667V13.432z"
                    />
                    <path
                      fill="#FFFFFF"
                      d="M52.365,13.432h-0.941l-0.077-0.543h-0.029c-0.323,0.433-0.782,0.65-1.377,0.65
              ...
              c0.231,0,0.445-0.073,0.642-0.218s0.317-0.331,0.362-0.558C51.272,11.944,51.278,11.883,51.278,11.812z"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M58.32,13.432h-0.931l-0.049-0.757h-0.029c-0.297,0.576-0.802,0.864-1.513,0.864
              ...
              c0.227,0.31,0.532,0.465,0.915,0.465c0.344,0,0.62-0.129,0.828-0.388C57.133,12.067,57.234,11.779,57.234,11.443z"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M64.025,10.852c0,0.188-0.014,0.346-0.039,0.475h-3.143c0.013,0.466,0.164,0.821,0.455,1.067
              ...
              c-0.174,0.227-0.277,0.498-0.31,0.815H63.025z"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M69.641,13.432h-1.048v-2.7c0-0.832-0.316-1.248-0.95-1.248c-0.311,0-0.562,0.114-0.757,0.343
              ...
              c0.361,0.349,0.543,0.87,0.543,1.562V13.432z"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M75.479,7.311c0,0.188-0.061,0.339-0.184,0.456c-0.123,0.117-0.281,0.175-0.475,0.175
              ...
              c0.18,0,0.332,0.059,0.455,0.175S75.479,7.13,75.479,7.311z M75.363,13.432h-1.049V8.717h1.049V13.432z"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M83.977,13.432h-1.027V10.79c0-0.871-0.299-1.306-0.893-1.306c-0.285,0-0.514,0.108-0.684,0.324
